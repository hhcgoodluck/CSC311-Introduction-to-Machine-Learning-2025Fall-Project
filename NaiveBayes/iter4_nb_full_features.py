...
def build_rating_matrix(df, rating_cols, neutral_value=3):
    ...
    For each column:
        ...
        - Replace missing values with `neutral_value`.
...
def main():
    ...
    # 4 rating + 8 best + 8 subopt = 20 structured features
    ...
    nb = MultinomialNB(alpha=1.0)  # baseline: Laplace smooth 1
    ...
    print(f"Training accuracy (NB, full features): {train_acc:.3f}")
    print(f"Test accuracy (NB, full features):     {test_acc:.3f}")
